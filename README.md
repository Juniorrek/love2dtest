...
## TODO
- NETWORK
    - Smooth client drawing/Client prediction
        - Level 1:
            - client moves immediately
            - server reply snaps/corrects if different
        - Level 2:
            - add input sequence numbers
            - client replays unconfirmed inputs after correction
        - Level 3:
            - smoother reconciliation
            - interpolation for remote players
            - less visible snapping
    ...
    - Interpolation for creatures and other players
...
- Tests with low FPS and high ping to see if things work properly
